    ...
    def __getitem__(self, index):
        ...
        if isinstance(index, str):
            if not self._allow_access_by_id:
                raise Exception('IndexedFastaCustom must be initialized with allowed_access_by_id to access by string identifier')
            ...
            raise Exception('indexing is supported by integer index, or by string identifier if allow_access_by_id=True was set')
