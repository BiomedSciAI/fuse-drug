...
* Add all needed tokens to [special_tokens.py](https://github.com/BiomedSciAI/fuse-drug/blob/5aaef572df7679606ec8a8a181013e54448f5ad5/fusedrug/data/tokenizer/modulartokenizer/special_tokens.py#L23)
...
* Run [ModularTokenizer creation](https://github.com/BiomedSciAI/fuse-drug/blob/main/fusedrug/data/tokenizer/modulartokenizer/test_multi_tokenizer_creation.py). The script will a. create a new tokenizer that contains all required added tokens and all the sub-tokenizers; and b. Test the resulting tokenizer for consistency.
...
An example of adding special tokens to an existing tokenizer is found here: [ModularTokenizer update](https://github.com/BiomedSciAI/fuse-drug/blob/5aaef572df7679606ec8a8a181013e54448f5ad5/fusedrug/data/tokenizer/modulartokenizer/test_multi_tokenizer_use.py#L35). The steps are as follows:
Short version:
* Update task_tokens in [special_tokens.py](https://github.com/BiomedSciAI/fuse-drug/blob/main/fusedrug/data/tokenizer/modulartokenizer/special_tokens.py) with the required tokens in 
* Run [ModularTokenizer use](https://github.com/BiomedSciAI/fuse-drug/blob/main/fusedrug/data/tokenizer/modulartokenizer/test_multi_tokenizer_use.py)
Long version:
* Load an existing modular tokenizer, like [here](https://github.com/BiomedSciAI/fuse-drug/blob/5aaef572df7679606ec8a8a181013e54448f5ad5/fusedrug/data/tokenizer/modulartokenizer/test_multi_tokenizer_use.py#L30)
* Create a list of the required tokens, similarly to [here](https://github.com/BiomedSciAI/fuse-drug/blob/5aaef572df7679606ec8a8a181013e54448f5ad5/fusedrug/data/tokenizer/modulartokenizer/test_multi_tokenizer_use.py#L35)
* Call ModularTokenizer.add_special_tokens() with the list: [add_tokens](https://github.com/BiomedSciAI/fuse-drug/blob/5aaef572df7679606ec8a8a181013e54448f5ad5/fusedrug/data/tokenizer/modulartokenizer/test_multi_tokenizer_use.py#L10)
