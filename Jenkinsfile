    ...
    stages {
        ...
        stage('Unit Test') {
            steps {
                ...
                chmod 766 ./run_all_unit_tests.sh
                jbsub -wait -out ccc_log.txt -queue x86_1h -mem 40g -cores "10+1" -require 'v100' ./run_all_unit_tests.sh 11.6 /dccstor/fuse_med_ml/fuse-drug/cicd/envs/
