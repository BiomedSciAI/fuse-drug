...
End to end train script with validation along the way, and testing in the end
"""
...
def main(cfg : DictConfig) -> None:
    ...
    #profiler = SimpleProfiler(dirpath=cfg.experiment.dir, filename="prof.log")
