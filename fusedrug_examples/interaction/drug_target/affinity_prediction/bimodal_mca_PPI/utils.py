...
def worker_init_fn(worker_id):
    ...
    # seed_val = np.random.get_state()[1][0] + worker_id + int(time() * 1000 % 1000)
...
# def split_classes(pairs_tsv:str, ligands_tsv:str, targets_tsv:str, 
#     splits_tsv:str, use_folds:Union[str,List[str]],
#     output_dir:str):
#     """    
#     """

#     #extract only the requested fold(s)
#     ds = DTIBindingDataset(pairs_tsv,ligands_tsv, targets_tsv, splits_tsv, use_folds)
